def build_prompt(category: str, language: str) -> str:
...
Бөлім атаулары да қазақша болсын:
...
Орысша сөйлемдер мен орысша бөлім атауларын қолданба.
"""
...
Названия разделов также должны быть на русском:
...
Не используй казахские предложения и казахские названия разделов.
"""
